...
namespace WebDashboardSecundaria.Controllers
{
    public class MateriasController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ID,Nombre,Estatus,EscuelaID")] Materias materias)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,Nombre,Estatus,EscuelaID")] Materias materias)
        {
            if (ModelState.IsValid)
            {
